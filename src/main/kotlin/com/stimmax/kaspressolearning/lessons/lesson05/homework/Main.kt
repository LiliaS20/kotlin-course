package org.example.com.stimmax.kaspressolearning.lessons.lesson05.homework
...
class Schedule {
    ...
    operator fun String.rangeTo(endTime: String): Pair<LocalTime, LocalTime> {
        return LocalTime.parse(this, timeFormatter) to LocalTime.parse(endTime, timeFormatter)
    }

    infix fun Pair<LocalTime, LocalTime>.schedule(name: String) {
        addSchedule(
            day ?: throw IllegalStateException("Не выбран день"),
